...
const Chatbox = () => {
  return (
    <div className="col-span-9 md:col-span-10 min-h-full relative min-w-full bg-gradient-to-r from-[#4136c3] via-[#FBC7D4] to-[#9796F0] opacity-90 rounded-tl-3xl overflow-hidden flex flex-col"> 
