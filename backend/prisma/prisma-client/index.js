...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/skyfish/Projects/confluence/backend/prisma/prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "binary"
  ...
  "inlineSchemaHash": "c90dbb38eb955794e16ad393fee0f296e0d9b92f0657a59108e83539a272ed01",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/prisma-client/query-engine-windows")

// file annotations for bundling tools to include these files
path.join(__dirname, "query-engine-debian-openssl-3.0.x");
path.join(process.cwd(), "prisma/prisma-client/query-engine-debian-openssl-3.0.x")
// file annotations for bundling tools to include these files
